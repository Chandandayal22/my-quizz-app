document.getElementById("ctgry1").addEventListener("click", hide1);
document.getElementById("ctgry2").addEventListener("click", hide1);
document.getElementById("ctgry3").addEventListener("click", hide1);
document.getElementById("ctgry4").addEventListener("click", hide1);
//  document.getElementById("submit").addEventListener ("click" , hide2);
...
//       /*yaha a + /10 for no of question show hoga.*/
//     }
...
const answerElements = document.querySelectorAll(".categorytypes");
const questionElement = document.getElementById("questionblock");
const a_text = document.getElementById("ans1");
const b_text = document.getElementById("ans2");
const c_text = document.getElementById("ans3");
const d_text = document.getElementById("ans4");
...
const loadQuiz = () => {
  deselectAnswers();
  const currentQuizData = myApp[0].quizWrap[currentQuiz];
...
submitButton.addEventListener("click", () => {
  ...
  if (answer) {
    if (answer === myApp[0].quizWrap[currentQuiz].correct) score++;
    currentQuiz++;
    if (currentQuiz < myApp[0].quizWrap.length) loadQuiz();
    else {
      container.innerHTML = `
<h2>You answered ${score}/${myApp[0].quizWrap.length} questions correctly</h2>
